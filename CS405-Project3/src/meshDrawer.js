...
void main()
{
	...
	// Diffuse light: cosine of angle between normal and light direction
	diff = max(dot(normal, lightdir), 0.0);

	// Reflection direction based on light direction and surface normal
	vec3 reflectDir = reflect(-lightdir, normal);

	// View direction: normalized vector from fragment to camera
	vec3 viewDir = normalize(-fragPos);

	// Specular light: sharpness controlled by phongExp
